...
# --- CONFIGURAÇÃO FINAL E SIMPLIFICADA PARA O RENDER ---
...
app = Flask(
    ...
    static_folder=None # Desativado para usarmos nossa rota personalizada
)
...
def login():
    ...
    # CAMINHO CORRIGIDO: Relativo a 'ArquivosGerais'
